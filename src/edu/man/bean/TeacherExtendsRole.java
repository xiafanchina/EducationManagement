 ...
 * 教师与角色实体类
 */
public class TeacherExtendsRole extends Role {
	  ...
	  private String idCard;//身份证
	   ...
	   private String course;//代课方向
	   private String workingWay;//办公方式
	   private String workingPlace;//常住地
	   private Date submitDate;//注册日期
	public String getId() {
		return id;
	}
